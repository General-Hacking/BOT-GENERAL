...
download_file('https://raw.githubusercontent.com/TH3BS/GENERAL/master/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end
download_file('https://raw.githubusercontent.com/TH3BS/download_file('https://raw.githubusercontent.com/TH3BS/GENERAL/master/inc/Run.lua','./inc/Run.lua')
/master/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
download_file('https://raw.githubusercontent.com/TH3BS/download_file('https://raw.githubusercontent.com/TH3BS/GENERAL/master/inc/Run.lua','./inc/Run.lua')
/master/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
download_file('https://raw.githubusercontent.com/TH3BS/download_file('https://raw.githubusercontent.com/TH3BS/GENERAL/master/inc/Run.lua','./inc/Run.lua')
/master/inc/functions.lua','./inc/functions.lua')
...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(General..":NameBot:") or "الزعيم"
...
var = redis:get(General..":RtbaNew1:"..ChatID) or 'مطور اساسي 👨🏻‍✈️' 
elseif redis:sismember(General..':SUDO_BOT:',UserID) then
var = redis:get(General..":RtbaNew2:"..ChatID) or 'مطور البوت 👨🏽‍💻' 
elseif redis:sismember(General..':MONSHA_Group:'..ChatID,UserID) then
var = redis:get(General..":RtbaNew3:"..ChatID) or ' المنشىء اساسي👷🏽' 
elseif redis:sismember(General..':MONSHA_BOT:'..ChatID,UserID) then
var = redis:get(General..":RtbaNew4:"..ChatID) or ' المنشىء 👷🏽' 
elseif redis:sismember(General..'owners:'..ChatID,UserID) then
var = redis:get(General..":RtbaNew5:"..ChatID) or 'مدير البوت 👨🏼‍⚕️' 
elseif redis:sismember(General..'admins:'..ChatID,UserID) then
var = redis:get(General..":RtbaNew6:"..ChatID) or 'ادمن في البوت 👨🏼‍🎓' 
elseif redis:sismember(General..'whitelist:'..ChatID,UserID) then
var = redis:get(General..":RtbaNew7:"..ChatID) or 'عضو مميز ⭐️' 
else
var = 'فقط عضو 🙍🏼‍♂️' 
end
return var
...
Replay = Replay:gsub("{البوت}",redis:get(General..':NameBot:'))
...
if msg.edited then
redis:incr(General..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info_ then
redis:incr(General..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.content_.ID == "MessageChatAddMembers" then 
redis:incr(General..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessagePhoto" then
redis:incr(General..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageSticker" then
redis:incr(General..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageVoice" then
redis:incr(General..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageAudio" then
redis:incr(General..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageVideo" then
redis:incr(General..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageAnimation" then
redis:incr(General..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local monshaas = redis:smembers(General..':MONSHA_Group:'..msg.chat_id_)
local monsha = redis:smembers(General..':MONSHA_BOT:'..msg.chat_id_)
local Owners = redis:smembers(General..'owners:'..msg.chat_id_)
local Admins = redis:smembers(General..'admins:'..msg.chat_id_)
local mmez = redis:smembers(General..'whitelist:'..msg.chat_id_)
...
local info  = redis:hgetall(General..'username:'..v)
...
local list = redis:smembers(General..':SUDO_BOT:')
message = '👨🏽‍💻*¦* قائمه الـمـطـوريـن : \n\n`★`*_* ['..SUDO_USER..'] ➣ (' ..SUDO_ID.. '){'..redis:scard(General..'mtwr_count'..SUDO_ID)..'}\n*----------------------------------*\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n📛 *"
else
for k,v in pairs(list) do
local info  = redis:hgetall(General..'username:'..v)
local count = redis:scard(General..'mtwr_count'..v)
if info and info.username and info.username:match("@[%a%d_]+") then
...
local list = redis:smembers(General..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(General..'admins:'..msg.chat_id_)
...
local list = redis:smembers(General..'whitelist:'..msg.chat_id_)
...
if redis:sismember(General..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(General..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(General..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(General..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(General..'gban_users')
...
local list = redis:smembers(General..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(General..':Filter_Word:'..msg.chat_id_,word) then 
return  "📝*¦* الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع✓️" 
else
redis:sadd(General..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(General..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(General..':Filter_Word:'..msg.chat_id_,word) 
...
local NumberFlood = tonumber(redis:get(General..':Flood_Spam:'..User..':'..ChatID..':msgs') or 0)
if NumberFlood >= 5 then 
result = false
else
redis:setex(General..':Flood_Spam:'..User..':'..ChatID..':msgs',2,NumberFlood+1)
result = true
end
return result
end
...
json_data = '{"BotID": '..General..',"UserBot": "'..Bot_User..'","Groups" : {'
local All_Groups_ID = redis:smembers(General..'group:ids')
for key,GroupS in pairs(All_Groups_ID) do
local NameGroup = (redis:get(General..'group:name'..GroupS) or '')
...
local admins = redis:smembers(General..'admins:'..GroupS)
if #admins ~= 0 then
json_data =  json_data..',"Admins" : {'
for key,value in pairs(admins) do
local info = redis:hgetall(General..'username:'..value)
if info then 
...
local creator = redis:smembers(General..':MONSHA_BOT:'..GroupS)
if #creator ~= 0 then
...
local owner = redis:smembers(General..'owners:'..GroupS)
if #owner ~= 0 then
...
local list = redis:smembers(General..'group:ids')
message = '📋*¦* قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(General..'group:name'..v)
if info then 
...
redis:del(
General..'group:add'..id_group,
General..'lock_link'..id_group, 
General..'lock_id'..id_group,
General..'lock_spam'..id_group, 
General..'lock_webpage'..id_group,
General..'lock_markdown'..id_group,
General..'lock_flood'..id_group,
General..'lock_bots'..id_group,
General..'mute_forward'..id_group,
General..'mute_contact'..id_group,
General..'mute_location'..id_group,
General..'mute_document'..id_group,
General..'mute_keyboard'..id_group,
General..'mute_game'..id_group,
General..'mute_inline'..id_group,
General..'lock_username'..id_group,
General..'num_msg_max'..id_group,
General..'mute_text'..id_group,
General..'admins:'..id_group,
General..':Filter_Word:'..id_group,
General..'banned:'..id_group,
General..'is_silent_users:'..id_group,
General..'whitelist:'..id_group,
General..':MONSHA_BOT:'..id_group,
General..'owners:'..id_group,
General..'replay'..id_group,
General..':MONSHA_Group:'..id_group
)
redis:srem(General..'group:ids',id_group)
end
...
NumAdmin = NumAdmin + 1
if not redis:sismember(General..'admins:'..arg.chat_id_,v.user_id_) then
GetUserID(v.user_id_,function(arg,data)
redis:hset(General..'username:'..data.id_,'username',ResolveUserName(data))
redis:sadd(General..'admins:'..arg.chat_id_,data.id_)
...
if redis:get(General..'group:add'..msg.chat_id_) then  return sendMsg(msg.chat_id_,msg.id_,'📮¦ بواسطه ⋙「 '..NameUser..' 」 \n📬¦ المجموعه بالتأكيد ✓️ تم تفعيلها \n✓️') end
...
local GroupUsers = tonumber(redis:get(General..':addnumberusers') or 0)
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(General..'username:'..data.id_,'username', ResolveUserName(data))
redis:sadd(General..':MONSHA_Group:'..arg.chat_id_,data.id_)
...
redis:mset(
General..'group:add'..arg.chat_id_,true,
General..'lock_link'..arg.chat_id_,true, 
General..'lock_id'..arg.chat_id_,true,
General..'lock_spam'..arg.chat_id_,true,
General..'lock_webpage'..arg.chat_id_,true,
General..'lock_markdown'..arg.chat_id_,true,
General..'lock_flood'..arg.chat_id_,true,
General..'lock_bots'..arg.chat_id_,true,
General..'mute_forward'..arg.chat_id_,true,
General..'mute_contact'..arg.chat_id_,true,
General..'mute_location'..arg.chat_id_,true,
General..'mute_document'..arg.chat_id_,true,
General..'mute_keyboard'..arg.chat_id_,true,
General..'mute_game'..arg.chat_id_,true,
General..'mute_inline'..arg.chat_id_,true,
General..'lock_username'..arg.chat_id_,true,
General..'num_msg_max'..arg.chat_id_,5, 
General..'lock_edit'..arg.chat_id_,true,
General..'replay'..arg.chat_id_,true,
General..'lock_rdodSource'..arg.chat_id_,true,
General.."lock_KickBan"..msg.chat_id_,true,
General.."lock_mmno3"..msg.chat_id_,true,
General.."lock_KickBan"..msg.chat_id_,true,
General.."lock_linkk"..msg.chat_id_,true
)
redis:sadd(General..'group:ids',arg.chat_id_) 
redis:sadd(General..'mtwr_count'..arg.sender_user_id_,arg.chat_id_)

local NameGroup = data.title_
redis:set(General..'group:name'..arg.chat_id_,NameGroup)
...
redis:set(General..'linkGroup'..arg.chat_id_,Gp_Link)
...
redis:hset(General..'username:'..UserID, 'username', Resolv)
redis:sadd(General..':tqeed:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم تقييده بنجاح \n✓")
end 
if cmd =="fktqeed" then
Restrict(ChatID,UserID,2)
redis:srem(General..':tqeed:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم فك تقييده بنجاح \n✓")
end
if cmd == "setwhitelist" then
if redis:sismember(General..'whitelist:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه مميز  في المجموعه \n✓") 
end
redis:hset(General..'username:'..UserID, 'username', Resolv)
redis:sadd(General..'whitelist:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه مميز  في المجموعه \n✓") 
end
if cmd == "remwhitelist" then
if not redis:sismember(General..'whitelist:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله مميز  في المجموعه \n✓") 
end
redis:srem(General..'whitelist:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله مميز  في المجموعه \n✓") 
end
if cmd == "setmnsha" then
if redis:sismember(General..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه منشئ  في المجموعه \n✓") 
end
redis:hset(General..'username:'..UserID, 'username', Resolv)
redis:sadd(General..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه منشئ  في المجموعه \n✓") 
end
if cmd == "remmnsha" then
if not redis:sismember(General..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله منشئ  في المجموعه \n✓") 
end
redis:srem(General..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله منشى  في المجموعه \n✓") 
end

if cmd == "setowner" then
if redis:sismember(General..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه مدير  في المجموعه \n✓") 
end
Resolv = Resolv:gsub([[\_]],"_")
redis:hset(General..'username:'..UserID, 'username', Resolv)
redis:sadd(General..'owners:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه مدير  في المجموعه \n✓") 
end
if cmd == "remowner" then
if not redis:sismember(General..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله مدير  في المجموعه \n✓") 
end
redis:srem(General..'owners:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله مدير  في المجموعه \n✓") 
end
if cmd == "promote" then
if redis:sismember(General..'admins:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه ادمن  في المجموعه \n✓") 
end
Resolv = Resolv:gsub([[\_]],"_")
redis:hset(General..'username:'..UserID, 'username', Resolv)
redis:sadd(General..'admins:'..ChatID,UserID) 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه ادمن  في المجموعه \n✓") 
end
if cmd == "demote" then
if not redis:sismember(General..'admins:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله ادمن  في المجموعه \n✓") 
end
redis:srem(General..'admins:'..ChatID,UserID)
...
if cmd == "Upmonsh" then
if redis:sismember(General..':MONSHA_Group:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه منشئ اساسي  في المجموعه \n✓") 
end
redis:hset(General..'username:'..UserID,'username',USERNAME)
redis:sadd(General..':MONSHA_Group:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه منشئ اساسي  في المجموعه \n✓") 
end

if cmd == "Dwmonsh" then
if not redis:sismember(General..':MONSHA_Group:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله منشئ اساسي  في المجموعه \n✓") 
end
redis:srem(General..':MONSHA_Group:'..ChatID,UserID) 
...
redis:hset(General..'username:'..UserID, 'username', Resolv)
redis:sadd(General..'banned:'..ChatID,UserID)
...
redis:hset(General..'username:'..UserID, 'username', Resolv)
redis:srem(General..'banned:'..ChatID,UserID)
StatusLeft(ChatID,UserID)
return false
end
...
redis:hset(General..'username:'..UserID, 'username', Resolv)
redis:sadd(General..'is_silent_users:'..ChatID,UserID)
...
redis:hset(General..'username:'..UserID, 'username', Resolv)
redis:srem(General..'is_silent_users:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم الغاء كتمه  من المجموعه \n✓") 
end

if cmd == "upMshrf" then
redis:hset(General..'username:'..UserID,'username',Resolv)
redis:setex(General..":uploadingsomeon:"..ChatID..msg.sender_user_id_,500,NameUser)
redis:setex(General..":uploadingsomeon2:"..ChatID..msg.sender_user_id_,500,UserID)
...
if cmd == "tfa3l" then  
local maseegs = redis:get(General..'msgs:'..UserID..':'..ChatID) or 1
local edited = redis:get(General..':edited:'..ChatID..':'..UserID) or 0
local content = redis:get(General..':adduser:'..ChatID..':'..UserID) or 0
if data.username_ then UserNameID = "@"..data.username_ else UserNameID = "لا يوجد" end  
...
.."\n📝¦ التعديل » "..(redis:get(General..'lock_edit'..msg.chat_id_) or 'false')
.."\n🔗¦ الروابط » "..(redis:get(General..'lock_link'..msg.chat_id_) or 'false')
.."\n#️⃣¦ التاك » "..(redis:get(General..'lock_tag'..msg.chat_id_) or 'false')
.."\n©¦ المعرفات » "..(redis:get(General..'lock_username'..msg.chat_id_) or 'false')
.."\n\n💱¦ التكرار » "..(redis:get(General..'lock_flood'..msg.chat_id_) or 'false')
.."\n📑¦ الكلايش » "..(redis:get(General..'lock_spam'..msg.chat_id_) or 'false')
.."\n🌐¦ الويب » "..(redis:get(General..'lock_webpage'..msg.chat_id_) or 'false')
.."\n⚜️¦ الماركدوان » "..(redis:get(General..'lock_markdown'..msg.chat_id_) or 'false')
.."\n🏌🏻¦ البوتات بالطرد » "..(redis:get(General..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n🤖¦ البوتات » "..(redis:get(General..'lock_bots'..msg.chat_id_) or 'false')
.."\n➕¦ عدد التكرار » "..(redis:get(General..'num_msg_max'..msg.chat_id_) or 'false')
.."\n⏰¦ وقت التنظيف » "..(redis:get(boGeneralss..':Timer_Cleaner:'..msg.chat_id_) or '6').." ساعة ."
.."\n\n🎬¦` اعدادات الوسائط :`\n"
.."\n🤹*¦* المتحركه » "..(redis:get(General..'mute_gif'..msg.chat_id_) or 'false')
.."\n◽️¦ الانلاين » "..(redis:get(General..'mute_inline'..msg.chat_id_) or 'false')
.."\n◽️¦ الانلاين » "..(redis:get(General..'mute_inline'..msg.chat_id_) or 'false')
.."\n💭¦ الدردشه » "..(redis:get(General..'mute_text'..msg.chat_id_) or 'false')
.."\n◽️¦ الانلاين » "..(redis:get(General..'mute_inline'..msg.chat_id_) or 'false')
.."\n🎮¦ الالعاب » "..(redis:get(General..'mute_game'..msg.chat_id_) or 'false')
.."\n🏞¦ الصور » "..(redis:get(General..'mute_photo'..msg.chat_id_) or 'false')
.."\n🎥¦ الفيديو » "..(redis:get(General..'mute_video'..msg.chat_id_) or 'false')
.."\n🎙¦ الصوت » "..(redis:get(General..'mute_audio'..msg.chat_id_) or 'false')
.."\n\n🔉¦ البصمات » "..(redis:get(General..'mute_voice'..msg.chat_id_) or 'false')
.."\n🎎¦ الملصقات » "..(redis:get(General..'mute_sticker'..msg.chat_id_) or 'false')
.."\n📞¦ الجهات » "..(redis:get(General..'mute_contact'..msg.chat_id_) or 'false')
.."\n💱¦ التوجيه » "..(redis:get(General..'mute_forward'..msg.chat_id_) or 'false')
.."\n🌐¦ الموقع » "..(redis:get(General..'mute_location'..msg.chat_id_) or 'false')
.."\n🗂¦ الملفات » "..(redis:get(General..'mute_document'..msg.chat_id_) or 'false')
.."\n🔅¦ الاشعارات » "..(redis:get(General..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n🔒¦ الفشار » "..(redis:get(General..'lock_mmno3'..msg.chat_id_) or 'false')
.."\n🔒¦ الفارسيه » "..(redis:get(General..'lock_pharsi'..msg.chat_id_) or 'false')
.."\n🔒¦ الانكليزيه » "..(redis:get(General..'lock_lang'..msg.chat_id_) or 'false')
.."\n🔒¦ الاضافه » "..(redis:get(General..'lock_Add'..msg.chat_id_) or 'false')

local eueuf = "\n\n*⚒¦*` اعدادات اخرى : `"
.."\n*🙋🏼‍♂️¦* الترحيب » "..(redis:get(General..'welcome:get'..msg.chat_id_) or 'false')
.."\n*📋¦*  الردود » "..(redis:get(General..'replay'..msg.chat_id_) or 'false')
.."\n*🚸¦*  التحذير » "..(redis:get(General..'lock_woring'..msg.chat_id_) or 'false')
.."\n*📝¦* الايدي » "..(redis:get(General..'lock_id'..msg.chat_id_) or 'false')
.."\n*💬¦* الرابط » "..(redis:get(General..'lock_linkk'..msg.chat_id_) or 'false')
.."\n*📮¦* المغادره » "..(redis:get(General..'lock_leftgroup'..msg.chat_id_) or 'false')
.."\n*🗳¦* الحظر » "..(redis:get(General..'lock_KickBan'..msg.chat_id_) or 'false')
.."\n*🔍¦* الحمايه » "..(redis:get(General..'antiedit'..msg.chat_id_) or 'false')
.."\n*📋¦* التاك للكل » "..(redis:get(General..'lock_takkl'..msg.chat_id_) or 'false')
.."\n*📒¦* الايدي بالصوره » "..(redis:get(General..'idphoto'..msg.chat_id_) or 'false')
.."\n*🔐¦* التحقق » "..(redis:get(General.."lock_check"..msg.chat_id_) or 'false')
.."\n*🗑¦* التنظيف التلقائي » "..(redis:get(General.."lock_cleaner"..msg.chat_id_) or 'false')
.."\n*📂¦* ردود السورس » "..(redis:get(General.."lock_rdodSource"..msg.chat_id_) or 'false')
...
.."\n*➕¦* عدد التكرار » "..(redis:get(General..'num_msg_max'..msg.chat_id_) or 'false')
.."\n\n*💱¦*` اعدادات التقـييد :`\n"
.."\n*💢¦* التقييد بالتوجيه » "..(redis:get(General..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*📸¦* التقييد بالصور » "..(redis:get(General..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*🔗¦* التقييد بالروابط » "..(redis:get(General..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*🎉¦* التقييد بالمتحركه » "..(redis:get(General..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*🎥¦* التقييد الفيديو » "..(redis:get(General..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '{ مقفول }')
list_settings = list_settings:gsub('false', '{ مفتوح }')
...
.."\n*🗂¦* الملفات » "..(redis:get(General..'mute_document'..msg.chat_id_) or 'false')
.."\n*🔅¦* الاشعارات » "..(redis:get(General..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n*🔒¦* الكيبورد » "..(redis:get(General..'mute_keyboard'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '{ مقفول }')
list_settings = list_settings:gsub('false', '{ مفتوح }')
return sendMsg(msg.chat_id_,msg.id_,'➖\n'..list_settings..'\n')
end
