...
General = Token:match("(%d+)")
redis:mset(
General..":VERSION",GetUser.information.Source_version,
General..":SUDO_ID:",GetUser.information.id,
General..":DataCenter:",GetUser.information.DataCenter,
General..":UserNameBot:",BOT_User,
General..":ApiSource",GetUser.information.WebSite,
General..":NameBot:","GENERAL",
"GENERAL_INSTALL","Yes"
)
redis:hset(General..'username:'..GetUser.information.id,'username','@'..GetUser.information.username:gsub('_',[[\_]]))
info = {} 
...
General = Token:match("(%d+)")
our_id = tonumber(General)
ApiGeneral = redis:get(General..":ApiSource")
ApiToken = "https://api.telegram.org/bot"..Token
Bot_User = redis:get(General..":UserNameBot:")
SUDO_ID = tonumber(redis:get(General..":SUDO_ID:"))
if not SUDO_ID then io.popen("rm -fr ./inc/Token.txt") end
SUDO_USER = redis:hgetall(General..'username:'..SUDO_ID).username
version = redis:get(General..":VERSION")
DataCenter = redis:get(General..":DataCenter:")
...
..'¦ BOT__INFO: \27[1;34m'.. Bot_User..'\27[0;36m » ('..General..')\027[0;32m\n'
...
..'¦ Api_Src->: \27[1;34m'..ApiGeneral..'\027[0;32m\n'
...
if not redis:get(General..":Check_Bot:"..W) then
Rgz,res=https.request(ApiGeneral..Tkml..W)
if res == 200 and Rgz == "SendMsg" then redis:setex(General..":Check_Bot:"..W,1800,true) return false else return Rgz end 
end 
end
...
if msg.type == "pv" and redis:get(General..':mute_pv:'..msg.sender_user_id_) then
print('\27[1;31m is_MUTE_BY_FLOOD\27[0m')
return false 
end
if msg.type ~= "pv" and redis:get(General..'sender:'..msg.sender_user_id_..':'..msg.chat_id_..'flood') then
print("\27[1;31mThis Flood Sender ...\27[0")
Del_msg(msg.chat_id_,msg.id_)
return false
end
if redis:get(General..'group:add'..msg.chat_id_) then 
...
and redis:get(General.."lock_cleaner"..msg.chat_id_) then
print("Clener >>> ")
redis:sadd(General..":IdsMsgsCleaner:"..msg.chat_id_,msg.id_)
Timerr = redis:get(General..':Timer_Cleaner:'..msg.chat_id_)
if Timerr then 
Timerr = tonumber(Timerr)
Timerr = 60*60*Timerr
end
redis:setex(General..":SetTimerCleaner:"..msg.chat_id_..msg.id_,Timerr or 21600,true)  
end



print(General..":IdsMsgsCleaner:"..msg.chat_id_)
local Cleaner = redis:smembers(General..":IdsMsgsCleaner:"..msg.chat_id_)
for k,v in pairs(Cleaner) do
if not redis:get(General..":SetTimerCleaner:"..msg.chat_id_..v) then
Del_msg(msg.chat_id_,v)
redis:srem(General..":IdsMsgsCleaner:"..msg.chat_id_,v)
...
if msg.GroupActive and redis:get(General..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
end
return false 
end 
...
msg.TheRankCmd = redis:get(General..":RtbaNew1:"..msg.chat_id_) or 'المطور الاساسي' 
msg.TheRank = redis:get(General..":RtbaNew1:"..msg.chat_id_) or 'مطور اساسي 👨🏻‍✈️' 
msg.Rank = 1
elseif redis:sismember(General..':SUDO_BOT:',msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(General..":RtbaNew2:"..msg.chat_id_) or 'المطور'
msg.TheRank = redis:get(General..":RtbaNew2:"..msg.chat_id_) or 'مطور البوت 👨🏽‍💻'
msg.Rank = 2
elseif msg.GroupActive and redis:sismember(General..':MONSHA_Group:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(General..":RtbaNew3:"..msg.chat_id_) or 'منشئ اساسي'
msg.TheRank = redis:get(General..":RtbaNew3:"..msg.chat_id_) or 'منشئ اساسي 👲🏼'
msg.Rank = 11
elseif msg.GroupActive and redis:sismember(General..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(General..":RtbaNew4:"..msg.chat_id_) or 'المنشىء'
msg.TheRank = redis:get(General..":RtbaNew4:"..msg.chat_id_) or 'المنشىء 👷🏽'
msg.Rank = 3
elseif msg.GroupActive and redis:sismember(General..'owners:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(General..":RtbaNew5:"..msg.chat_id_) or 'المدير' 
msg.TheRank = redis:get(General..":RtbaNew5:"..msg.chat_id_) or 'مدير البوت 👨🏼‍⚕️' 
msg.Rank = 4
elseif msg.GroupActive and redis:sismember(General..'admins:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(General..":RtbaNew6:"..msg.chat_id_) or 'الادمن'
msg.TheRank = redis:get(General..":RtbaNew6:"..msg.chat_id_) or 'ادمن في البوت 👨🏼‍🎓'
msg.Rank = 5
elseif msg.GroupActive and redis:sismember(General..'whitelist:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRank = redis:get(General..":RtbaNew7:"..msg.chat_id_) or 'عضو مميز'
msg.Rank = 6
...
local lock_bots = redis:get(General..'lock_bots'..msg.chat_id_)
ZISBOT = false
...
if msg.GroupActive and ZISBOT and redis:get(General..'lock_bots_by_kick'..msg.chat_id_) then
kick_user(msg.sender_user_id_, msg.chat_id_)
end
if msg.content_.members_[0].id_ == our_id and redis:get(General..':WELCOME_BOT') then
SUDO_USER = redis:hgetall(General..'username:'..SUDO_ID).username
sendPhoto(msg.chat_id_,msg.id_,redis:get(General..':WELCOME_BOT'),[[💯¦ مـرحبآ آنآ بوت آسـمـي ]]..redis:get(General..':NameBot:')..[[ 🎖
...
if not msg.Special and not msg.Admin and redis:get(General.."lock_Add"..msg.chat_id_) then
...
if redis:get(General.."lock_check"..msg.chat_id_) and not redis:get(General..":TqeedUser:"..msg.chat_id_..Senderid) then
...
if msg.Special or msg.Admin then redis:srem(General..'is_silent_users:'..msg.chat_id_,msg.sender_user_id_) return false end
...
if msg.Special then redis:srem(General..'banned:'..msg.chat_id_,msg.sender_user_id_) return end
...
if redis:get(General..'mute_text'..msg.chat_id_) then --قفل الدردشه
...
if ScriptFile and ScriptFile.General then 
if msg.text and ScriptFile.iGeneral then
XGeneral = ScriptFile.General
local list = redis:hgetall(General..":AwamerBotArray:"..msg.chat_id_)
for General2,k in pairs(list) do
Text = msg.text
Text2 = k
if Text:match(General2) then 
local amrr = {Text:match(General2)}
local AmrOld = redis:hgetall(General..":AwamerBotArray2:"..msg.chat_id_)
amrnew = "" amrold = ""
...
GetMsg = ScriptFile.iGeneral(msg,{Text:match(Text2)})
if GetMsg then
...
for k, General in pairs(XGeneral) do
Text = msg.text
Text = Text:gsub("ی","ي")
Text = Text:gsub("ک","ك")
Text = Text:gsub("ه‍","ه")
if Text:match(General) then -- Check Commands To admin
AF = CheckBotA(msg) if AF then return sendMsg(msg.chat_id_,msg.id_,AF) end 
GetMsg = ScriptFile.iGeneral(msg,{Text:match(General)})
if GetMsg then
print("\27[1;35m¦This_Msg : ",General.." | Plugin is: \27[1;32mScript.lua\27[0m")
sendMsg(msg.chat_id_,msg.id_,GetMsg)
return false
end 
end
...
if ScriptFile.dGeneral then
if ScriptFile.dGeneral(msg) == false then
return false
end
...
if Plug.General then 
if msg.text and Plug.iGeneral then
for k, General in pairs(Plug.General) do
if msg.text:match(General) then
local GetMsg = Plug.iGeneral(msg,{msg.text:match(General)})
if GetMsg then
print("\27[1;35m¦This_Msg : ",General.." | Plugin is: \27[1;32m"..name.."\27[0m")
sendMsg(msg.chat_id_,msg.id_,GetMsg)
end 
return false
end
...
if Plug.dGeneral then
Plug.dGeneral(msg)
print("\27[1;35m¦Msg_IN_Process : \27[1;32"..name.."\27[0m")
end
else
print("The File "..name.." Not Runing in The Source General")
end 

end
else
print("The File Script.lua Not Runing in The Source General")
end
end
...
redis:srem(General..'users',msg.sender_user_id_)
end
...
if redis:get(General..":propin"..msg.chat_id_) == msg.content_.text_ then
redis:del(General..":propin"..msg.chat_id_)
...
if redis:get(General..'group:add'..data.chat_.id_) then
redis:set(General..'group:name'..data.chat_.id_,data.chat_.title_)
end
elseif data.ID == "UpdateChannel" then  
if data.channel_.status_.ID == "ChatMemberStatusKicked" then 
if redis:get(General..'group:add-100'..data.channel_.id_) then
local linkGroup = (redis:get(General..'linkGroup-100'..data.channel_.id_) or "")
local NameGroup = (redis:get(General..'group:name-100'..data.channel_.id_) or "")
...
redis:mset(
General..'group:name'..k,IDS.Title,
General..'num_msg_max'..k,5,
General..'group:add'..k,true,
General..'lock_link'..k,true,
General..'lock_spam'..k,true,
General..'lock_webpage'..k,true,
General..'lock_markdown'..k,true,
General..'lock_flood'..k,true,
General..'lock_bots'..k,true,
General..'mute_forward'..k,true,
General..'mute_contact'..k,true,
General..'mute_document'..k,true,
General..'mute_inline'..k,true,
General..'lock_username'..k,true,
General..'replay'..k,true
)
redis:sadd(General..'group:ids',k) 

if IDS.Admins then
for user,ID in pairs(IDS.Admins) do
redis:hset(General..'username:'..ID,'username',user)
redis:sadd(General..'admins:'..k,ID)
end
end
if IDS.Creator then
for user,ID in pairs(IDS.Creator) do
redis:hset(General..'username:'..ID,'username',user)
redis:sadd(General..':MONSHA_BOT:'..k,ID)
end
end
if IDS.Owner then
for user,ID in pairs(IDS.Owner) do
redis:hset(General..'username:'..ID,'username',user)
redis:sadd(General..'owners:'..k,ID)
end
end
end
io.popen("rm -fr ../.telegram-cli/data/document/*")
sendMsg(Uploaded_Groups_CH,Uploaded_Groups_MS,'📦*¦* تم رفع آلنسـخهہ‏‏ آلآحتيآطـيهہ\n⚖️*¦* حآليآ عدد مـجمـوعآتگ هہ‏‏يهہ‏‏ *'..redis:scard(General..'group:ids')..'* 🌿\n✓')
end
elseif data.ID == "UpdateUser" then  
if data.user_.type_.ID == "UserTypeDeleted" then
print("¦ userTypeDeleted")
redis:srem(General..'users',data.user_.id_)
elseif data.user_.type_.ID == "UserTypeGeneral" then
local CheckUser = redis:hgetall(General..'username:'..data.user_.id_).username
...
redis:hset(General..'username:'..data.user_.id_,'username',USERNAME)
end 
end
